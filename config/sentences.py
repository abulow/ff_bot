...
team1 + ' sign ' + position2 + ' ' + player2 + '. This means the end of the road for ' + player1 + ', who was cut. ' + team1 + ' spent ' + auction + ' of their waiver budget in the move.' ,
...
'Update: ' + team1 + ' sign ' + player2 + ' to address ' + position2 + ' shortage, place ' + player1 + ' on waivers. They made the highest bid with ' + auction + '.',
...
'Update: ' + team1 + ' sign ' + player2 + ' to address ' + position2 + ' shortage, place ' + player1 + ' on waivers.',

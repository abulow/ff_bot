...
'If you are a follower then you know me, I am not one to be crude on this platform. However, I can only describe the latest trade involving ' + player1 + ' and ' + player2 + ' as ' + team2 + ' willfully bending over at ' + team1 + '\'s request to perform unspeakable acts.',
...
'I like to think that know people know who I am more than know who ' + player2 + ' is. That changed today as ' + team1 + ' signed him and cut ' + player1 + ' for ' + auction + '.',
...
'The waiver competition is steaming like Marc\'s jacuzzi. ' + team1 + ' is clearly trying to win like Jake did on that fateful night. They won the ' + player2 + ' lottery, only spending ' + auction + ' on the move and dropping ' + player1 + '.',
team1 + '\'s coach just stormed into the press conference clearly inebriated, grabbing his crotch, and yelling, \"SUCK ON THESE.\" Surely the front office had a party after acquiring ' + player2 + ' off waivers and spending ' + auction + ' on the move.',
